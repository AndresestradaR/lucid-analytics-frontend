...
export default function Dashboard() {
  ...
  const [walletHistory, setWalletHistory] = useState(null)  // NUEVO: historial de cartera
  ...
  useEffect(() => {
    if (selectedAccount) {
      loadDashboard()
      loadDropiData()
      loadWalletHistory()  // NUEVO: cargar historial de cartera
    }
  ...
  // NUEVO: Cargar historial de cartera (ingresos/egresos)
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {loading ? (
        ...
        <>
          ...
          {/* NUEVO: Consolidado de Cartera (Ingresos y Egresos del período) */}
            ...
            <div className="glass rounded-2xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <p className="text-dark-400 text-sm">Ingresos y egresos del período seleccionado</p>
                </div>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className={`${walletHistory.summary.net >= 0 ? 'bg-lucid-500/10 border-lucid-500/20' : 'bg-orange-500/10 border-orange-500/20'} rounded-xl p-4 border`}>
                  <div className="flex items-center gap-2 mb-2">
          ...
          {/* NUEVO: Gráfica de Ingresos vs Egresos por Día */}
            ...
            <div className="glass rounded-2xl p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  ...
                  <p className="text-dark-400 text-sm">Movimientos de cartera en el período seleccionado</p>
                </div>
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-green-500" />
                    <span className="text-sm text-dark-300">Ingresos</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <div className="w-3 h-3 rounded-full bg-red-500" />
                    <span className="text-sm text-dark-300">Egresos</span>
                  </div>
                </div>
              </div>
