        ...
        <>
          ...
          {walletHistory?.summary && dropiData?.connected && (
            <div className="space-y-4">
              ...
              {/* Gráfica de Ganancias Dropshipping vs Devoluciones - POR FECHA DE CREACIÓN */}
              {dropiData?.orders && (
                <div className="glass rounded-2xl p-6">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                  ...
                  {/* Resumen con CRUCE DE DATOS - Órdenes vs Wallet */}
                  {dropiData?.reconciliation ? (
                    <>
                      {/* Fila 1: Ganancias (Cobradas + Pendientes) */}
